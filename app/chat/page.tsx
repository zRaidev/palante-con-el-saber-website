...
export const metadata: Metadata = {
  title: "El Compa AI | Pa'lante Con El Saber",
  description: "El Compa AI es un chatbot desarrollado por el equipo de Pa'lante con el Saber que ayuda a jóvenes panameños a elegir su bachillerato. El chatbot utiliza inteligencia artificial para proporcionar información personalizada sobre las diferentes opciones de bachillerato disponibles en Panamá, ayudando a los estudiantes a tomar decisiones informadas sobre su futuro académico.",
